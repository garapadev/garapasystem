      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          ...
          {canAccess.colaboradores.create && (
            <Button onClick={() => router.push('/configuracoes/colaboradores/novo')}>
                        ...
                        <div className="flex items-center space-x-2">
                          {canAccess.colaboradores.read && (
                            <Button 
                              variant="ghost" 
                              size="sm"
                              onClick={() => router.push(`/configuracoes/colaboradores/${colaborador.id}`)}
                            >
                          ...
                          {canAccess.colaboradores.update && (
                            <Button 
                              variant="ghost" 
                              size="sm"
                              onClick={() => router.push(`/configuracoes/colaboradores/${colaborador.id}/editar`)}
                            >
