          ...
          <TableCell>
            <div className="flex items-center space-x-2">
              <Button 
                variant="ghost" 
                size="sm"
                onClick={() => router.push(`/configuracoes/grupos-hierarquicos/${grupo.id}`)}
              >
              ...
              {canAccess.grupos.update && (
                <Button 
                  variant="ghost" 
                  size="sm"
                  onClick={() => router.push(`/configuracoes/grupos-hierarquicos/${grupo.id}/editar`)}
                >
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          ...
          {canAccess.grupos.create && (
            <Button onClick={() => router.push('/configuracoes/grupos-hierarquicos/novo')}>
