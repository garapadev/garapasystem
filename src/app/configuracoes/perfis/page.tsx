      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          {canAccess.perfis.create && (
            <Button onClick={() => router.push('/configuracoes/perfis/novo')}>
                          ...
                          <TableCell>
                            <div className="flex items-center space-x-2">
                              <Button 
                                variant="ghost" 
                                size="sm"
                                onClick={() => router.push(`/configuracoes/perfis/${perfil.id}`)}
                              >
                              ...
                              {canAccess.perfis.update && (
                                <Button 
                                  variant="ghost" 
                                  size="sm"
                                  onClick={() => router.push(`/configuracoes/perfis/${perfil.id}/editar`)}
                                >
